/**
 * popular-articles.js
 * Progressive-enhancement controls for sections/popular-articles.liquid.
...
(function () {
  ...
  function initAll() {
    document.querySelectorAll('.popular-articles').forEach(initCarousel);
  }
  ...
  document.addEventListener('shopify:section:load', function (event) {
    var section = event.target.querySelector('.popular-articles');
