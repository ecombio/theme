...
(() => {
  ...
  function buildModal() {
    ...
    // [F] Append to body, not documentElement — keeps the modal inside the
    //     flex-column stacking context and ensures z-index works correctly
    //     relative to the sticky header and cart drawer.
