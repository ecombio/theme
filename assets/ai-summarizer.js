(function () {
  ...
  function showToast(message, isError) {
    var toast = document.getElementById('ai-summarizer-toast');
    if (!toast) return;

    var textEl = toast.querySelector('.ai-summarizer-toast__text');
  ...
  document.addEventListener('DOMContentLoaded', function () {
    var container = document.querySelector('.ai-summarizer');
    if (!container) return;
    ...
    var buttons      = container.querySelectorAll('.ai-summarizer__btn');
