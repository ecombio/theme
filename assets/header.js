/* assets/header.js
   Behavior for the section-level navigation system: sticky header height
   sync + scroll autohide, the desktop menu-bar scroll-fade, and the mobile
   nav drawer (open/close + submenu toggles).
   Self-contained: loaded by sections/header.liquid itself.

   The sticky/autohide logic below was migrated here from main-header.js:
   it targets [data-sticky-fixed="true"] and #main-header-sticky-spacer,
   both of which are rendered by sections/header.liquid itself, so it
   belongs in this file rather than the main-header snippet's script.
*/
