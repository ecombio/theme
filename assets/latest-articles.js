/**
 * latest-articles.js
 * Progressive-enhancement controls for sections/latest-articles.liquid.
...
(function () {
  ...
  function initAll() {
    document.querySelectorAll('.latest-articles').forEach(initCarousel);
  }
  ...
  document.addEventListener('shopify:section:load', function (event) {
    var section = event.target.querySelector('.latest-articles');
