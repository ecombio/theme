/* assets/main-search.js
   ...
   backdrop, and the sort select. No tab-switching JS: Products/
   Articles are two separately-paginated searches (type=product
   vs type=article), so the tabs are plain <a href> links and a
   tab click is just a normal page navigation. */
